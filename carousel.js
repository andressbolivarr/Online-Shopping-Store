...
function updateParallax() {
  ...
  let x = gsap.getProperty('#slides1', 'x') + window.innerWidth / 2,
...
window.addEventListener('resize', ()=>{
  Draggable.get("#slides1").applyBounds({left: innerWidth/2, width:1})
  updateParallax();
});
